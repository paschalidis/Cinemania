...
public class DatabaseTest {
    ...
    private final Class mDbHelperClass = CinemaniaDbHelper.class;
    ...
    public void create_database_test() throws Exception{
        ...
        /* Use CinemaniaDbHelper to get access to a writable database */
        ...
        assertEquals("Error: Your database was created without the expected tables.",
                CinemaniaContract.MovieEntry.TABLE_NAME, tableNameCursor.getString(0));
