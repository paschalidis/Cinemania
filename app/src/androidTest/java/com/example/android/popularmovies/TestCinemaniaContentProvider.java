...
import com.example.android.popularmovies.database.CinemaniaContentProvider;
import com.example.android.popularmovies.database.CinemaniaContract;
import com.example.android.popularmovies.database.CinemaniaDbHelper;
...
public class TestCinemaniaContentProvider {
    ...
    public void setUp() {
        ...
        CinemaniaDbHelper dbHelper = new CinemaniaDbHelper(mContext);
        SQLiteDatabase database = dbHelper.getWritableDatabase();
        database.delete(CinemaniaContract.MovieEntry.TABLE_NAME, null, null);
    }
...
//        String taskProviderClassName = CinemaniaContentProvider.class.getName();
...
//    }
    ...
    private static final Uri TEST_MOVIES = CinemaniaContract.MovieEntry.CONTENT_URI;
...
//        UriMatcher testMatcher = CinemaniaContentProvider.buildUriMatcher();
//
//        /* Test that the code returned from our matcher matches the expected TASKS int */
//        String tasksUriDoesNotMatch = "Error: The MOVIE URI was matched incorrectly.";
//        int actualTasksMatchCode = testMatcher.match(TEST_MOVIES);
//        int expectedTasksMatchCode = CinemaniaContentProvider.MOVIES;
...
//                "Error: The MOVIES_WITH_ID URI was matched incorrectly.";
//        int actualTaskWithIdCode = testMatcher.match(TEST_MOVIE_WITH_ID);
//        int expectedTaskWithIdCode = CinemaniaContentProvider.MOVIES_WITH_ID;
...
//        testValues.put(CinemaniaContract.MovieEntry.COLUMN_THE_MOVIE_DB_ID_, "31262");
//        testValues.put(CinemaniaContract.MovieEntry.COLUMN_POSTER_PATH, "test_poster_path");
//        testValues.put(CinemaniaContract.MovieEntry.COLUMN_ORIGINAL_TITLE, "test title");
//        testValues.put(CinemaniaContract.MovieEntry.COLUMN_OVERVIEW, "test overview");
//        testValues.put(CinemaniaContract.MovieEntry.COLUMN_RELEASE_DATE, "18/8/2014");
//
...
//
//
//        Uri uri = contentResolver.insert(CinemaniaContract.MovieEntry.CONTENT_URI, testValues);
//
//
//        Uri expectedUri = ContentUris.withAppendedId(CinemaniaContract.MovieEntry.CONTENT_URI, 1);
//
...
//    }
    ...
    public void testQuery() {
        ...
        /* Create values to insert */
        ContentValues testValues = new ContentValues();
        testValues.put(CinemaniaContract.MovieEntry._ID, "31262");
        testValues.put(CinemaniaContract.MovieEntry.COLUMN_POSTER_PATH, "test_poster_path");
        testValues.put(CinemaniaContract.MovieEntry.COLUMN_ORIGINAL_TITLE, "test title");
        testValues.put(CinemaniaContract.MovieEntry.COLUMN_OVERVIEW, "test overview");
        testValues.put(CinemaniaContract.MovieEntry.COLUMN_RELEASE_DATE, "18/8/2014");
        ...
        long taskRowId = database.insert(
                ...
                CinemaniaContract.MovieEntry.TABLE_NAME,
                null,
    ...
    public void testDelete() {
        ...
        CinemaniaDbHelper helper = new CinemaniaDbHelper(InstrumentationRegistry.getTargetContext());
        ...
        Uri uriToDelete = CinemaniaContract.MovieEntry.CONTENT_URI.buildUpon().appendPath(String.valueOf(taskRowId)).build();
